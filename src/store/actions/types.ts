...
const MARK_SALE_MANAGER_CHATS_AS_READ = compose(ACTION_NAME.MARK_SALE_MANAGER_CHATS_AS_READ);
const MARK_ADMIN_CHATS_AS_READ = compose(ACTION_NAME.MARK_ADMIN_CHATS_AS_READ);
